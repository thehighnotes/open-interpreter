...
- [Hub Tools](#hub-tools)
  - [hub — Meta-Tool](#hub-meta-tool)
  - [repo — Git Management](#repo-git-management-tool)
  - [Session Flow: work → prepare → begin → autosummary](#session-flow-work-prepare-begin-autosummary)
  - [overview — Project Briefings](#overview-project-briefings)
  - [research — Arxiv & GitHub Monitor](#research-arxiv-github-monitor)
  - [backup — Hub Ecosystem Backup](#backup-hub-ecosystem-backup)
  - [code — Code Assistant Client](#code-code-assistant-client)
  - [edit — Structured File Editing](#edit-structured-file-editing)
  - [health-probe — Host & Service Monitor](#health-probe-host-service-monitor)
...
The `tools/hub/` directory contains a suite of CLI tools that manage a multi-machine development environment. Each tool is a standalone Python script that can be run directly from the terminal or through OI's [magic commands](#oi-integration).
