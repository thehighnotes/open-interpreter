...
class SubprocessLanguage(BaseLanguage):
    ...
    def start_process(self):
        ...
        try:
            # Start in project directory if OI_PROJECT_PATH is set
            _cwd = os.environ.get("OI_PROJECT_PATH") or None
        ...
        # Works for both bash (bind) and zsh (unset zle bracketed-paste)
        init_cmd = (
            "PS1=''; PS2=''; "
